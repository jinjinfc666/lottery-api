...
public class Gd11x5BettingTest extends ControllerJunitBase{
		
	public Gd11x5BettingTest(String name) {
		super(name);
	}
				...
				Thread exe = new Thread(new Runnable(){
					...
					public void run() {
						...
						try {
							...
							bis = new ByteArrayInputStream(mapper.writeValueAsBytes(array));
							WebRequest request = new PostMethodWebRequest("http://localhost:8080/lotteries/gd11x5/bet/zh/1/wallet/15",
									bis,
									MediaType.APPLICATION_JSON_VALUE);
							WebConversation wc = new WebConversation();
				...
				Thread exe = new Thread(new Runnable(){
					...
					public void run() {
						...
						try {
							...
							WebRequest request = new PostMethodWebRequest("http://localhost:8080/lotteries/gd11x5/pre-bet",
									bis,
									MediaType.APPLICATION_JSON_VALUE);
							WebConversation wc = new WebConversation();
	...
	public Map<String, Object> queryCurrIssue(String token, String lottoType) throws Exception{
		...
		try {
			...
			for(Map<String, Object> temp : playTypesMap) {
				//id=1, lotteryType=gd11x5, classification=qszx|前三直选, ptName=fs, ptDesc=复式, state=1, mulSinFlag=1, isHidden=1, seq=1, createTime=1533895746000
	...
	public void testBetting_gd11x5() throws Exception{
		int maxTimes = 600000;
		int counter = 0;
		String lottoType = "gd11x5";
