...
public class Pk10Dx2PlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public Pk10Dx2PlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "dx|大小/dem|第二名/fs-ds";
