...
public class Pk10Ds2PlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public Pk10Ds2PlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "ds|单双/dem|第二名/fs-ds";
