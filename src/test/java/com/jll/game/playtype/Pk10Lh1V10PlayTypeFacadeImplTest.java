...
public class Pk10Lh1V10PlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public Pk10Lh1V10PlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "lh|龙虎/1v10|1v10/fs-ds";
