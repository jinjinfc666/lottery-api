...
public class Pk10QyzxPlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public Pk10QyzxPlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "qyfs|前一复式/fs-ds";
