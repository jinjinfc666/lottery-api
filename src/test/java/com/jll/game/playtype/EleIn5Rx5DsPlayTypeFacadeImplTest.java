...
public class EleIn5Rx5DsPlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public EleIn5Rx5DsPlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "rx|任选/rxwzw|任选五中五/ds";
	...
	public void testIsMatchWinningNum_winning(){
		...
		betNum = "01 02 03 09 06;08 09 10 11";
		issue = new Issue();
		issue.setRetNum("01,02,03,09,06");
	...
	public void testPreProcessNumber(){
		...
		params = new HashMap<>();
		//Date startTime = new Date();
		betNum = "01 02 03 04 05;04 05 06 07 08";
		times = 1;
		monUnit = 1.0F;
		playType = 1;
		//lottoType = "cqssc";
	...
	public void testParseBetNumber(){
		...
		betNum = "01 02 03 04 05;07 08 09 10 11";
		startDate = new Date();
		...
		Assert.assertTrue(ret.size() == 240);
	}
	
	
	public void testValidBetNum_invalid_betnum_(){
		String betNum = "00 01 02 03 04";
		OrderInfo order = new OrderInfo();
	...
	public void testValidBetNum_valid_betnum_(){
		...
		betNum = "01 02 03 04 05;03 04 05 06 07";
		order = new OrderInfo();
