...
public class BdwZsPlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public BdwZsPlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "bdw|不定位/zsbdwfs";
