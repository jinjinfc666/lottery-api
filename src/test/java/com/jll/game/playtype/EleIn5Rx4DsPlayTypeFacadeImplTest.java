...
public class EleIn5Rx4DsPlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public EleIn5Rx4DsPlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "rx|任选/rxszs|任选四中四/ds";
	...
	public void testIsMatchWinningNum_winning(){
		...
		betNum = "01 02 03 09;08 09 10 11";
		issue = new Issue();
		issue.setRetNum("01,02,03,09,06");
	...
	public void testPreProcessNumber(){
		...
		params = new HashMap<>();
		//Date startTime = new Date();
		betNum = "01 02 03 04;04 05 06 07";
		times = 1;
		monUnit = 1.0F;
		playType = 1;
		//lottoType = "cqssc";
	...
	public void testParseBetNumber(){
		...
		Assert.assertTrue(ret.size() == 840);
		
		betNum = "01 02 03 04;07 08 09 10";
		startDate = new Date();
		...
		Assert.assertTrue(ret.size() == 1680);
	}
	
	
	public void testValidBetNum_invalid_betnum_(){
		String betNum = "00 01 02 03";
		OrderInfo order = new OrderInfo();
	...
	public void testValidBetNum_valid_betnum_(){
		...
		betNum = "01 02 03 04;03 04 05 06";
		order = new OrderInfo();
