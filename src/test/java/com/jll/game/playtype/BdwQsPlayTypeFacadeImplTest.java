...
public class BdwQsPlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public BdwQsPlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "bdw|不定位/qsbdwfs";
