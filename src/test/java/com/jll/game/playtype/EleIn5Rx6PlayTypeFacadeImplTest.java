...
public class EleIn5Rx6PlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public EleIn5Rx6PlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "rx|任选/rxlzw|任选六中五/fs-ds";
	...
	public void testCalPrize_10070603110209040105(){
		String winningNum = "04,09,11,10,03";
		String betNum = "10070603110209040105";
		...
		Assert.assertTrue(prize.compareTo(new BigDecimal(359.334F)) == 0);
	}
}