...
public class EleIn5Rx8PlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public EleIn5Rx8PlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "rx|任选/rxbzw|任选八中五/fs-ds";
