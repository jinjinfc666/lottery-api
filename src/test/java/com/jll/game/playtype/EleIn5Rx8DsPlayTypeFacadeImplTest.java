...
public class EleIn5Rx8DsPlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public EleIn5Rx8DsPlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "rx|任选/rxbzw|任选八中五/ds";
	...
	public void testIsMatchWinningNum_winning(){
		String betNum = "01 02 03 09 06 07 08 09";
		...
		betNum = "01 02 03 09 06 07 08 09;08 09 10 11 07 06 05 04";
		issue = new Issue();
		issue.setRetNum("01,02,03,09,06");
	...
	public void testPreProcessNumber(){
		...
		String betNum = "01 02 03 04 05 06 07 08";
		Integer times = 1;
		Float monUnit = 1.0F;
		Integer playType = 1;
		...
		params = new HashMap<>();
		//Date startTime = new Date();
		betNum = "01 02 03 04 05 06 07 08;04 05 06 07 08 09 10 11";
		times = 1;
		monUnit = 1.0F;
		playType = 1;
		//lottoType = "cqssc";
	...
	public void testParseBetNumber(){
		...
		Assert.assertTrue(ret.size() == 6720);
		
		betNum = "01 02 03 04 05 06 07 08;07 08 09 10 11 06 05 04";
		startDate = new Date();
		...
		Assert.assertTrue(ret.size() == 13440);
	}
	
	
	public void testValidBetNum_invalid_betnum_(){
		String betNum = "00 01 02 03 04 05 06 07";
		OrderInfo order = new OrderInfo();
		...
		betNum = "12 01 02 03 04 05 06 07";		
		order = new OrderInfo();
		...
		betNum = "01 02 03 04 05 06 07 08 09";
		order = new OrderInfo();
		...
		betNum = "01 01 02 03 04 05 06 07";
		order = new OrderInfo();
	...
	public void testValidBetNum_valid_betnum_(){
		...
		betNum = "01 02 03 04 05 06 07 08;03 04 05 06 07 08 09 10";
		order = new OrderInfo();
