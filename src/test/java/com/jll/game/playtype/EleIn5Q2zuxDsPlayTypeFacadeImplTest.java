...
public class EleIn5Q2zuxDsPlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public EleIn5Q2zuxDsPlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "em|二码/qezux|前二组选/ds";
	...
	public void testIsMatchWinningNum_winning(){
		...
		betNum = "01 02;08 07";
		issue = new Issue();
		issue.setRetNum("10,02,03,09,06");
	...
	public void testParseBetNumber(){
		...
		Assert.assertTrue(ret.size() == 5324);
	}
