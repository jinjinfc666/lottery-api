...
public class EleIn5Rx1DsPlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public EleIn5Rx1DsPlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "rx|任选/rxyzy|任选一中一/ds";
	...
	public void testParseBetNumber(){
		...
		Assert.assertTrue(ret.size() == 50400);
	}
