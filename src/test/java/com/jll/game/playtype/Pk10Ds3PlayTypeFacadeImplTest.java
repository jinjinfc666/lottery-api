...
public class Pk10Ds3PlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public Pk10Ds3PlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "ds|单双/dsm|第三名/fs-ds";
