...
public class Pk10Ds1PlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public Pk10Ds1PlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "ds|单双/dym|第一名/fs-ds";
