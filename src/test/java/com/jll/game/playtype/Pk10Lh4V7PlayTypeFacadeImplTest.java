...
public class Pk10Lh4V7PlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public Pk10Lh4V7PlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "lh|龙虎/4v7|4v7/fs-ds";
	...
	public void testIsMatchWinningNum_winning(){
		...
		betNum = "01";
		issue = new Issue();
		issue.setRetNum("09,01,02,03,04,05,06,07,08,10");
