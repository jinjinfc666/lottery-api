...
public class BdwHsPlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public BdwHsPlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "bdw|不定位/hsbdwfs";
