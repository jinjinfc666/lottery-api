...
public class EleIn5Rx4PlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public EleIn5Rx4PlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	public void ItestIsMatchWinningNum_winning(){
		...
		issue.setRetNum("01,02,04,03,06");
