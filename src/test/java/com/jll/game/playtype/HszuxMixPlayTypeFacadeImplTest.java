...
public class HszuxMixPlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public HszuxMixPlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "hszux|后三组选/hhzxds";
