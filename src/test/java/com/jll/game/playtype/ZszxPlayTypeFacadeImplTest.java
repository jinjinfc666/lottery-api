...
public class ZszxPlayTypeFacadeImplTest extends ServiceJunitBase{
	...
	final String facadeName = "zszx|中三直选/fs";
	...
	public void testIsMatchWinningNum_winning(){
		...
		betNum = "0123456789,0123456789,0123456789;8,9,7";
		issue = new Issue();
		issue.setRetNum("9,1,2,3,6");
