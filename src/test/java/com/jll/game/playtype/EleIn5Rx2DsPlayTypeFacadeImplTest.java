...
public class EleIn5Rx2DsPlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public EleIn5Rx2DsPlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "rx|任选/rxeze|任选二中二/ds";
	...
	public void testParseBetNumber(){
		...
		Assert.assertTrue(ret.size() == 20160);
	}
