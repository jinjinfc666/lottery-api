...
public class QszuxZlPlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public QszuxZlPlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "qszux|前三组选/zlfs";
