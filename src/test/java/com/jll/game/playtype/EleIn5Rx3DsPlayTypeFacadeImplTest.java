...
public class EleIn5Rx3DsPlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public EleIn5Rx3DsPlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "rx|任选/rxszs|任选三中三/ds";
