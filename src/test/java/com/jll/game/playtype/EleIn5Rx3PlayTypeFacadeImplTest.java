...
public class EleIn5Rx3PlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public EleIn5Rx3PlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "rx|任选/rxszs|任选三中三/fs-ds";
	...
	public void testCalPrize_03080910051107020401(){
		String winningNum = "04,09,11,10,03";
		String betNum = "03080910051107020401";
		...
		Assert.assertTrue(prize.compareTo(new BigDecimal(154.051F)) == 0);
	}
}