...
public class EleIn5QszxDsPlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public EleIn5QszxDsPlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "sm|三码/qszx|前三直选/ds";
	...
	public void testParseBetNumber(){
		...
		Assert.assertTrue(ret.size() == 121);
		...
		Assert.assertTrue(ret.size() == 242);		
	}
