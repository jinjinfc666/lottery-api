...
public class Pk10Dx3PlayTypeFacadeImplTest extends ServiceJunitBase{
		
	public Pk10Dx3PlayTypeFacadeImplTest(String name) {
		super(name);
	}	
	...
	final String facadeName = "dx|大小/dsm|第三名/fs-ds";
