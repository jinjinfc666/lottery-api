...
public class EleIn5Rx7DsPlayTypeFacadeImpl  extends DefaultPlayTypeFacadeImpl {
	
	private Logger logger = Logger.getLogger(EleIn5Rx7DsPlayTypeFacadeImpl.class);
	
	protected String playTypeDesc = "rx|任选/rxqzw|任选七中五/ds";
