...
public class EleIn5Rx1DsPlayTypeFacadeImpl  extends DefaultPlayTypeFacadeImpl {
	
	private Logger logger = Logger.getLogger(EleIn5Rx1DsPlayTypeFacadeImpl.class);
	
	protected String playTypeDesc = "rx|任选/rxyzy|任选一中一/ds";
	...
	public Map<String, Object> calPrize(Issue issue, OrderInfo order, UserInfo user) {
		...
		for(String singleSel : betNumMul) {	
			singleSel = singleSel.replaceAll(" ", "");
