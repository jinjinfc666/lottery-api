...
public class EleIn5Wxq2PlayTypeFacadeImpl  extends DefaultPlayTypeFacadeImpl {
	
	private Logger logger = Logger.getLogger(EleIn5Wxq2PlayTypeFacadeImpl.class);
	
	protected String playTypeDesc = "em|二码/qezx|前二直选/fs-ds";
